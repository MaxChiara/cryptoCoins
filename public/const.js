...
const homeTableValues = [
    "name",
    "total_supply",
    "max_supply",
    "quote.EUR.volume_24h",
    "quote.EUR.percent_change_1h",
    "quote.EUR.percent_change_24h",
    "quote.EUR.price",
];
const quoteTableValues = [
    "name",
    "total_supply",
    "max_supply",
    "quote.EUR.volume_24h",
...
const numberFormat = [
    ...
    "Price_change_7d",
    "Price_change_30d",
]; //i valori di homeTableValues che saranno formattati come numeri
const greenRedFormat = [
    "Price_change_1h",
    "Price_change_24h",
    "Price_change_7d",
    "Price_change_30d",
]; //valori di homeTableValues che saranno verdi se positivi e rossi se negativi
var homeTableId = [];
